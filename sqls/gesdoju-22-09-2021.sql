...
INSERT INTO `normas` VALUES (2,'Ley de Contrato de Trabajo','20744','Ley','Laboral','1974-09-11','1974','01','CS','BL001','Ley de Contrato de Trabajo','ley contrato trabajo.pdf','../../uploads/ley contrato trabajo.pdf'),(3,'Ley de Ministerios','22520','Ley','Estructura','1981-12-21','1981','20','PN','BL001','Modifica y complementa 3 normas, Ley 60, Ley 21801/78, 22450/81 y es modificada y/o complementada por 190 normas.','ley 22520.pdf','../../uploads/ley 22520.pdf'),(6,'Regimen Legal de Contrato de Teletrabajo','27555','Ley','Laboral','2020-07-30','2020','05','MT','BL001','ESTABLECER LOS PRESUPUESTOS LEGALES MINIMOS PARA LA REGULACION DE LA MODALIDAD DE TELETRABAJO EN AQUELLAS ACTIVIDADES, QUE POR SU NATURALEZA Y PARTICULARES CARACTERISTICAS, LO PERMITAN. LOS ASPECTOS ESPECIFICOS SE ESTABLECERAN EN EL MARCO DE LAS NEGOCIACIONES COLECTIVAS.','ley_27555.pdf','../../uploads/ley_27555.pdf');
...
--
-- Table structure for table `segmentacion_tematica`
--

DROP TABLE IF EXISTS `segmentacion_tematica`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `segmentacion_tematica` (
  ...
  `desc_organismo` varchar(120) NOT NULL,
  `reg_paritario` varchar(100) DEFAULT NULL,
  `esc_estatuto` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `segmentacion_tematica`
--

LOCK TABLES `segmentacion_tematica` WRITE;
/*!40000 ALTER TABLE `segmentacion_tematica` DISABLE KEYS */;
/*!40000 ALTER TABLE `segmentacion_tematica` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tipo_organismo` VALUES (1,'01','ADMINISTRACION CENTRAL'),(2,'02','BANCOS OFICIALES'),(3,'03','EMPRESA'),(4,'04','EMPRESAS INTERESTATALES'),(5,'05','EMPRESAS RESIDUALES'),(6,'06','EMPRESAS Y SOCIEDADES DEL ESTADO'),(7,'07','ENTES BINACIONALES'),(8,'08','ENTES INTERETADUALES'),(9,'09','INSTITUCIONES DE LA SEGURIDAD SOCIAL'),(10,'10','OBRAS SOCIALES ESTATALES'),(11,'11','ORGANISMOS DESCENTRALIZADOS'),(12,'12','OTROS ENTES DEL SECTOR PUBLICO NACIONAL NO FINANCIERO'),(13,'13','OTROS ENTES INTERESTADUALES'),(14,'14','OTROS ENTES PUBLICOS EMPRESARIALES'),(15,'15','UNIVERSIDADES NACIONALES');
/*!40000 ALTER TABLE `tipo_organismo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `unidades_retributivas`
--

DROP TABLE IF EXISTS `unidades_retributivas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `unidades_retributivas`
--

LOCK TABLES `unidades_retributivas` WRITE;
/*!40000 ALTER TABLE `unidades_retributivas` DISABLE KEYS */;
INSERT INTO `unidades_retributivas` VALUES (1,'A','0',452,706,1158),(2,'A','1',452,706,1158),(3,'A','2',452,706,1158),(4,'A','3',452,706,1158),(5,'A','4',452,706,1158),(6,'A','5',452,706,1158),(7,'A','6',452,706,1158),(8,'A','7',452,706,1158),(9,'A','8',452,706,1158),(10,'A','9',452,706,1158),(11,'A','10',452,706,1158),(12,'B','0',316,492,808),(13,'B','1',316,492,808),(14,'B','2',316,492,808),(15,'B','3',316,492,808),(16,'B','4',316,492,808),(17,'B','5',316,492,808),(18,'B','6',316,492,808),(19,'B','7',316,492,808),(20,'B','8',316,492,808),(21,'B','9',316,492,808),(22,'B','10',316,492,808),(23,'C','0',216,338,554),(24,'C','1',216,338,554),(25,'C','2',216,338,554),(26,'C','3',216,338,554),(27,'C','4',216,338,554),(28,'C','5',216,338,554),(29,'C','6',216,338,554),(30,'C','7',216,338,554),(31,'C','8',216,338,554),(32,'C','9',216,338,554),(33,'C','10',216,338,554),(34,'D','0',188,293,481),(35,'D','1',188,293,481),(36,'D','2',188,293,481),(37,'D','3',188,293,481),(38,'D','4',188,293,481),(39,'D','5',188,293,481),(40,'D','6',188,293,481),(41,'D','7',188,293,481),(42,'D','8',188,293,481),(43,'D','9',188,293,481),(44,'D','10',188,293,481),(45,'E','0',152,236,388),(46,'E','1',152,236,388),(47,'E','2',152,236,388),(48,'E','3',152,236,388),(49,'E','4',152,236,388),(50,'E','5',152,236,388),(51,'E','6',152,236,388),(52,'E','7',152,236,388),(53,'E','8',152,236,388),(54,'E','9',152,236,388),(55,'E','10',152,236,388),(56,'F','0',146,228,374),(57,'F','1',146,228,374),(58,'F','2',146,228,374),(59,'F','3',146,228,374),(60,'F','4',146,228,374),(61,'F','5',146,228,374),(62,'F','6',146,228,374),(63,'F','7',146,228,374),(64,'F','8',146,228,374),(65,'F','9',146,228,374),(66,'F','10',146,228,374);
/*!40000 ALTER TABLE `unidades_retributivas` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-09-22 16:45:15
