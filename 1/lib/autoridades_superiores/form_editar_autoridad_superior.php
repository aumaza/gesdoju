...
?>
      ...
      <!DOCTYPE html>
		<html lang="es">
		<head>
		  <title>GESDO [ Editar Autoridad Superior ]</title>
		...
		<body style = "background: #839192;">
	      ...
	      $one_as->formEditAutoridadSuperior($one_as,$id,$organismo,$normativa,$descripcion,$conn,$dbase);
	  	  }else{
	  	  	echo "sin conexion";
	  	  }
	...
	<script type="text/javascript" src="lib_autoridades_superiores.js"></script>
