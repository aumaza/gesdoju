...
include "../../functions/functions.php";
	...
	$sql = "select nombre from usuarios where user = '$user'";
  ...
  echo '</head><body>';
	...
	$sql = "SELECT * FROM usuarios where user = '$user' and password = '$pass' and role = 1";
	$q = mysqli_query($conn,$sql);
	
	$query = "SELECT * FROM usuarios where user = '$user' and password = '$pass' and role = 0";
...
<div id="wrapper">
<hr>
<p><strong><img class="img-reponsive img-rounded" src="../../icons/actions/meeting-attending.png" /> Usuario: </strong><?php echo $nombre ?></p>
<hr>
<?php
}
...
{
    ?>
<hr><p class="center"><small><img class="img-reponsive img-rounded" src="../../icons/places/user-home.png" /> Bienvenido a Explorer de Gesdoju</small></p><hr>
</div>
<script>
